...
Use the LinkNode class into create a Circularly Linked List (CLL). Use any resources you want to research a CLL, but be
sure to cite them. Include a write up defending your reasoning for what methods you include and the big-O cost of each method.

NOTES: The big O is mentioned on the top of every method.

Reference: - OpenDSA Chapter 10.1 LinkedList
*/
...
public class CircularlyLinkedList<E> implements List<E>{
    ...
    // Move curr one step right; Will go to head if curr is at the last element  -> Big O: 1
    public void next() {
        if (curr.next() != tail)
            curr = curr.next();
        else {
